...
@section('content')
    ...
    @endif
    <form class="form-section formboxbg" id="form-league" method="POST" action="{{ route('admin.sub-team.store', [$id, $language_id]) }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mainform-sec">
            ...
            <div class="input-group">
                ...
                @if ($team->team_logo)
                    ...
                    <input type="hidden" name="existing_team_logo" value="{{ $team->team_logo }}">
                @endif
            </div>
            <div class="input-group">
