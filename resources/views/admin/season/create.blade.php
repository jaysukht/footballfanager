...
@section('content')
    ...
    @endif
    <form class="form-section formboxbg" id="form-league" method="POST" action="{{ route('admin.seasons.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mainform-sec">
            <div class="input-group">
                ...
                <input type="text" class="form-control name" id="name" name="name"
                    value="{{ old('name') }}" placeholder="Season Name">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control slug" id="slug" name="slug"
                    value="{{ old('slug') }}" placeholder="Season Localized Name">
