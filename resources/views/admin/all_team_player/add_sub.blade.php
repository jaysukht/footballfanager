    ...
    @section('content')
        ...
        @endif
        <form class="form-section formboxbg" id="form-league" method="POST" action="{{ route('admin.sub-all-team-player.store', [$all_team_player->id, $language_id]) }}" enctype="multipart/form-data">
            @csrf
