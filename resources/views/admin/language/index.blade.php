...
@section('content')
    ...
    <div class="filter-top-sec request-wrapper">
        <div class="manageuser">
            <a href="{{ route('admin.languages.create') }}" class="btn common-btn">Add</a>
        </div>
    </div>
    <div class="dashboard-table-sec oddeven-table search-mt">
        <table id="language-table" class="display table responsive nowrap" width="100%">
            <thead>
                <tr>
                    <th>#ID</th>
                    <th>Language</th>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#language-table').DataTable({
                ...
                pageLength: 20,
                ajax: "{{ route('admin.languages.data') }}",
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
