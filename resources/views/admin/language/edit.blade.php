    ...
    @section('content')
        ...
        @endif
        <form class="form-section formboxbg" id="form-language" method="POST" action="{{ route('admin.languages.update', $language->id) }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mainform-sec">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control shortname" id="shortname" name="shortname"
                        value="{{ old('shortname', $language->shortname ?? '') }}" placeholder="Language Short Name">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control fullname" id="fullname" name="fullname"
                        value="{{ old('fullname', $language->fullname ?? '') }}" placeholder="Language Name">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control slug" id="slug" name="slug"
                        value="{{ old('slug', $language->slug ?? '') }}" placeholder="Language Localized Name">
                ...
                <div class="input-group">
                    ...
                    @if ($language->lang_flag)
                        <div class="mb-3">
                            <img src="{{ asset('assets/images/language_flags/' . $language->lang_flag) }}" width="100">
                        </div>
                    @endif
