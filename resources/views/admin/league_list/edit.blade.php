    ...
    @section('content')
        ...
        @endif
        <form class="form-section formboxbg" id="form-league" method="POST" action="{{ route('admin.league-list.update', [$league_list->id, $language_id, $default_language_post_id]) }}" enctype="multipart/form-data">
            @csrf
