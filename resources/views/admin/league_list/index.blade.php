...
@section('content')
    ...
    <div class="filter-top-sec request-wrapper">
        <div class="manageuser">
            <a href="{{ route('admin.league-list.create') }}" class="btn common-btn">Add</a>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#match-table').DataTable({
                ...
                pageLength: 20,
                ajax: {
                    url: '{{ route('admin.league-list.data') }}',
                    dataType: 'json',
                    data: function(d) {
            ...
            $(document).on('click', '.delete-record', function() {
                ...
                let url = "{{ route('admin.league-list.delete') }}";
