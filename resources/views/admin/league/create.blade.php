    ...
    @section('content')
        ...
        @endif
        <form class="form-section formboxbg" id="form-league" method="POST" action="{{ route('admin.leagues.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mainform-sec">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control name" id="name" name="name"
                        value="{{ old('name') }}" placeholder="League Name">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control slug" id="slug" name="slug"
                        value="{{ old('slug') }}" placeholder="League Slug">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control custom_permalink" id="custom_permalink" name="custom_permalink"
                        value="{{ old('custom_permalink') }}" placeholder="Custom Permalink">
                ...
                <div class="input-group">
                    ...
                    <textarea class="form-control description" id="description" name="description" placeholder="League Description">{{ old('description') }}</textarea>
