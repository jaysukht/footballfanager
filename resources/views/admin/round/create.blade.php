    ...
    @section('content')
        ...
        @endif
        <form class="form-section formboxbg" id="form-league" method="POST" action="{{ route('admin.rounds.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mainform-sec">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control name" id="name" name="tag_name"
                        value="{{ old('tag_name') }}" placeholder="Round Name">
                    @error('tag_name')
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control slug" id="slug" name="slug"
                        value="{{ old('slug') }}" placeholder="Round Localized Name">
                    @error('slug')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control slug" id="custom_uri" name="custom_uri"
                        value="{{ old('custom_uri') }}" placeholder="Display Alias">
                    @error('custom_uri')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
