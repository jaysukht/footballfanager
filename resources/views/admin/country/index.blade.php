...
@section('content')
    ...
    <div class="filter-top-sec request-wrapper">
        <div class="report-selectbox1 request-cls-status">
            <select id="filter_language" class="form-select">
    ...
    <div class="filter-top-sec request-wrapper">
        <div class="manageuser">
            <a href="{{ route('admin.countries.create') }}" class="btn common-btn">Add</a>
        </div>
    </div>
    
    <div class="dashboard-table-sec oddeven-table search-mt">
        <table id="country-table" class="display table responsive nowrap" width="100%">
            <thead>
                <tr>
                    <th>#ID</th>
                    <th>Country</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-record', function() {
                ...
                let url = "{{ route('admin.countries.delete') }}";
